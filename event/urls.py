...
urlpatterns = [
    ...
    re_path(r'^profile/(?P<pk>[0-9]+)/$', views.get_user_profile, name='user_profile'),
    path('past_events/', views.get_past_events, name='past_events'),
    re_path(r'^add_money/(?P<pk>[0-9]+)/$', views.add_money, name='add_money'),
    re_path(r'^withdraw_money/(?P<pk>[0-9]+)/$', views.withdraw_money, name='withdraw_money'),
